      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text"
              class="form-control" name="duracion" id="" aria-describedby="helpId" placeholder="" value="{{$marketing->fechainicio}}">
          </div>
          <div class="mb-3">
    ...
    <div class="modal fade" id="delete{{$marketing->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <form action="{{route('inventario.destroy',$marketing->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('DELETE')
            <div class="modal-body">
              <div class="mb-3">
